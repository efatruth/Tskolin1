...
#liður 6 Búið til forrit sem leggur saman allar tölur á ákveðnu bili.
#T.d. ef bilið er frá 5 upp í 11 á niðurstaðan að vera 56
#því 5+6+7+8+9+10+11 eru 56. Notandinn á að ákveða hvaða bil er valið.
...
#liður 7 Búið til forrit sem skrifar út  margföldunartöflu.Forritið spyr um hvaða
#línu eigi að skrifa. Ef t.d. er beðið um línu 3 ætti að skrifast:
