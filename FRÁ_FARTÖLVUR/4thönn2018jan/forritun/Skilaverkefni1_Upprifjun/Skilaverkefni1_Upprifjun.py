...
while val!=6:
    ...
    if val==1:
        ...
        #raðaður listinn
        talnalisti.sort()#raða listanum
        print(talnalisti)
        print("heðsta talan er =",max(talnalisti))
        print("lagsta talan er =", min(talnalisti))
        print("summa talan er =", sum(talnalisti))
        ...
        print("\nfjöldi talna yfir 250 er", telja_up)
        ...
        while val2!="5":    # herna hadu afram þanngað til val2 verður 5
            ...
            if val2 == "1":
                ...
                print(nafnlisti[valnafn - 1])
            elif val2 =="4":
                syna_nafn = int(input("hvað er númer? "))
                print("nafnið er", nafnlisti[syna_nafn-1])
            elif val2 == "5":
                print("þákk fyrir")
            else:
                print("upps eithvað")
