...
class AnnarKlasi:
    ...
    def samlagning(self,tala1,tala2):
        utkoma = tala1 + tala2
        return utkoma
...
n1 = int(input('Sláðu inn fyrri tölu:'))
n2 = int(input('Sláðu inn seinni tölu: '))

print('Tölurnar lagðar saman:', i1.samlagning(n1,n2))
print('Tölurnar margfaldaðar saman:', i2.margfoldun(n1, n2))
print('Fyrri talan deilt með þeirri seinni:', round(i3.deiling(n1, n2), 2))
