...
while val !=7:
    print(".............................")
    print("dæmi.1,tölurnar lagðar saman og margfaldaðar ")
    print("dæmi.2,fornafn og eftirnafn")
    print("dæmi.3,lengd í kílómetrum og metrar")
    print("dæmi.4,um laun á klukkustund ")
    print("dæmi.5,heildarlaun og skatt")
    print("dæmi.6,fjölda gráða")
    ...
    if val =="1":
        ...
        hringir=gradur//360
        afgangu = gradur%360
        print("það eru",hringir,"hringir og",afgangu,"grádur ")
